...
while running:
    ...
    # Draw the basket
    paddle = pygame.draw.rect(screen, (255, 255, 255), [bar_x, bar_y_value, bar_width, bar_length])
    ...
    if ball_pos_y + ball_radius >= bar_y_value and bar_x <= ball_pos_x <= bar_x + bar_width:
        ball_speed_y *= -1
    elif ball_pos_y <= 2:
        ball_speed_y *= -1
    if ball_pos_x >= width:
